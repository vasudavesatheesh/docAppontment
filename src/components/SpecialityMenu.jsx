...
const SpecialityMenu = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality' >
      ...
      <p className='sm:w-1/3 text-center text-sm'>Simply Browse Throught Our Great LIst of Trusted Doctors,and find your specialised doctors with good skills</p>
